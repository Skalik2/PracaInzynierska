...
MODEL_FILE = './weights/bot_occ_modelH1U10-50-40-10.pkl'
...
def load_model_and_apply_encoders(X_df):
    if not os.path.exists(MODEL_FILE):
        print(f"BŁĄD: Brak modelu {MODEL_FILE}. Uruchom najpierw detect_bot_occ.py")
        sys.exit(1)
...
def visualize(X, y_true, model):
    ...
    print(f"ANALIZA PCA (Odwzorowanie 2D):")
